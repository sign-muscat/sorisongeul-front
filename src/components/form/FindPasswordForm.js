...
//                                     </InputLeftElement>
//                                     <Input type="email" fontSize="12px" placeholder="이메일을 입력하세요" name="email" value={email}
...
//
//                             {showCodeInput && (
//                                 <FormControl mt={2} isInvalid={!isCodeValid}>
//                                     <FormLabel fontSize="12px" color="#333">인증번호</FormLabel>
//                                     <InputGroup>
//                                         <InputLeftElement pointerEvents="none">
//                                             <Key color="#BDBDBD" />
//                                         </InputLeftElement>
//                                         <Input type="text" fontSize="12px" placeholder="인증코드를 입력하세요" name="code" value={code}
...
//                                     </InputGroup>
//                                     {!isCodeValid && (
//                                         <Text color="red.500" fontSize="12px">인증 번호가 올바르지 않습니다.</Text>
//                                     )}
//                                 </FormControl>
//                             )}
//                             <Button
...
//                                 <InputGroup>
//                                     <Input type="password" fontSize="12px" placeholder="새 비밀번호를 입력하세요" name="newPassword"
...
//                                 <InputGroup>
//                                     <Input type="password" fontSize="12px" placeholder="비밀번호를 다시 입력하세요" name="confirmPassword"
//                                            onChange={onChangeHandler}/>
//                                 </InputGroup>
//                             </FormControl>
//                             <Button
